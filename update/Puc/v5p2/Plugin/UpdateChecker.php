<?php
namespace ZeosWeb\PluginUpdateChecker\v5p2\Plugin;

use ZeosWeb\PluginUpdateChecker\v5p2\InstalledPackage;
use ZeosWeb\PluginUpdateChecker\v5p2\UpdateChecker as BaseUpdateChecker;
use ZeosWeb\PluginUpdateChecker\v5p2\Scheduler;
use ZeosWeb\PluginUpdateChecker\v5p2\DebugBar;
...
if ( !class_exists(UpdateChecker::class, false) ):
	...
	class UpdateChecker extends BaseUpdateChecker {
		...
		public function __construct($metadataUrl, $pluginFile, $slug = '', $checkPeriod = 12, $optionName = '', $muPluginFile = ''){
			...
			//Details: https://github.com/ZeosWeb/plugin-update-checker/issues/138#issuecomment-335590964
